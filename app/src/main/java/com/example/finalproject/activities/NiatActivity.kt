...
import kotlinx.android.synthetic.main.list_data2.*
...
class NiatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler_view_niat.layoutManager = LinearLayoutManager(this)
        //rvDM.setHasFixedSize(true)
        recycler_view_niat.adapter = dataAdapter
    ...
    private fun getDM() {
        try {
            val stream = assets.open("niatbacashalat.json")
